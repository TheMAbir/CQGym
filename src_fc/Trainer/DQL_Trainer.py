...
from src_fc.Models.DQL import DQL
import torch
import random
...
def model_training(env, weights_file_name=None, is_training=False, output_file_name=None,
    ...
    dql = DQL(env,num_inputs, output_size, learning_rate,
    ...
    while not done:
        ...
        dql.remember(obs.feature_vector, action_p,
...
def model_engine(module_list, module_debug, job_cols=0, window_size=0, sys_size=0,
                 ...
                 learning_rate=1e-5, reward_discount=0.99, batch_size=10, layer_size=[],alg_str='DQL'):
    """
