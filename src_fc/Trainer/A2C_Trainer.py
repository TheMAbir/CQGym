...
from src_fc.Models.A2C import A2C
import random
import torch
...
def model_training(env, weights_file_name=None, is_training=False, output_file_name=None,
    ...
    a2c = A2C(env, num_inputs, output_size, std=0.0, window_size=window_size,
    ...
    while not done:
        ...
        a2c.remember(probs, value, reward, done, device, action_origin)
...
def model_engine(module_list, module_debug, job_cols=0, window_size=0, sys_size=0,
                 is_training=False, weights_file=None, output_file=None, do_render=False, learning_rate=0.1, reward_discount=0.99, batch_size=10, layer_size=[],on_cuda=None,alg_str='A2C'):
    """
