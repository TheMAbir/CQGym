...
if __name__ == "__main__":
    ...
    p.add_option("--rl_alg", dest="rl_alg", type="string",
                 default="FCFS",
                 help="scheduling agent: PG; A2C; PPO; FCFS;SJF")
    ...
    p.add_option("--on_cuda",dest = "on_cuda",type="string",
                 default="",
                 help="gpu index on your computer"
                 )
    ...
    # 若在运行时,命令行中没有指定相关参数,则使用文件中默认写的参数进行读取
    if opts.config_sys:
    ...
    inputPara['on_cuda'] = opts.on_cuda
